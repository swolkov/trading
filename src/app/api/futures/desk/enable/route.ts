import { clearAnomaly, setDeskEnabled, loadState } from "@/lib/futures-desk";
...
export async function POST(request: Request) {
  ...
  if (body.action !== "enable") return Response.json({ error: "action must be enable | disable | clear-anomaly" }, { status: 400 });
